...
router.get(
  "/settings/categories",
  catchErrors(categoriesController.categories)
);
router.get(
  "/settings/categories/add",
  authController.isLoggedIn,
  catchErrors(categoriesController.addCategory)
);
router.post(
  "/settings/categories/add",
  categoriesController.processCategory,
...
router.get(
  ...
  authController.isLoggedIn,
  catchErrors(categoriesController.editCategory)
);
router.get(
  "/settings/category/:id/remove",
  authController.isLoggedIn,
  catchErrors(categoriesController.removeCategory)
);
